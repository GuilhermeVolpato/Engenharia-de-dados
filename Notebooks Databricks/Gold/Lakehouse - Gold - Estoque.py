...
df_estoque.write.format('delta').save(f"/mnt/{storageAccountName}/gold/Estoque")
...
spark.read.format('delta').load(f'/mnt/{storageAccountName}/gold/Estoque').limit(10).display()
